            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="bg-amber-300 p-4 flex justify-between">
                        <div>
                            FILTER LAPORAN URAIAN PENDAPATAN
                        </div>
                    </div>
                    <div class="mt-6">
                        <form id="filterForm" action="{{ route('laporanUraian.create') }}" method="GET" target="_blank">
                            ...
                            <div class="flex flex-col p-4 space-y-6">
                                ...
                                <div>
                                    ...
                                    <select class="js-example-placeholder-single js-states form-control w-full m-6"
                                        id="uraian" name="uraian" data-placeholder="Pilih Uraian Pendapatan">
