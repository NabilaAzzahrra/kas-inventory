        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mt-6">
                        <form id="filterForm" action="{{ route('laporanHarian.create') }}" method="GET" target="_blank">
                            ...
                            <div class="flex flex-col p-4 space-y-6">
                                ...
                                <div id="tunai-container">
                                    <label class="block mb-2 text-sm font-medium text-gray-900">Tunai 1</label>
                                    <input type="number" name="tunai_1"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
                                <div class="flex space-x-2">
                                    <button type="button" onclick="addTunaiInput()"
                                        class="bg-blue-500 text-white px-4 py-2 rounded">
                                        Tambah Tunai
                                    </button>
                                    <button type="button" onclick="removeTunaiInput()"
